...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth]{geometryR.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.9\textwidth]{geometryAR.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=.7\textwidth]{effectiveTOC.png}
	\caption{Effective TOC for TE modes at \SI{1.55}{\um}.}
	\label{fig_variation}
\end{figure}
...
In Figure (\ref{fig_variation}) is represented the effective TOC of different modes, for wavelength $\lambda = \SI{1.55}{\um}$.

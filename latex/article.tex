  ...
  \begin{tabular}{lcccc}  
    ...
    \cmidrule(r){2-5}
    	\multirow{2}{*}{Materials}    & $\rho$ & $\kappa_{TH}$ & $C_P$ & TOC\\
  		& [\si{\kg\m^3}] & [\si{\W\per\m\per\K}] & [\si{\J\per\kg\per\K}] & [$10^{-4}$\si{\per\K}] \\
    \midrule
    Silicon (Si)			& 2329	& 130	& 700	& 1.87\\
...
Specifically, we used a polynomial expression of fifth order in wavelength and of second order in temperature ``\texttt{poly52}".

...
\begin{figure}[!h]
	...
	\caption{Peak position at $T_{amb}$. The label of the x axis are to be read as pump-signal-idler combinations. In order there are TE conbinations and TM combinations.}
...
\begin{figure}[!h]
	...
	\caption{Change of peak position. The label of the x axis are to be read as pump-signal-idler combinations. In order there are TE conbinations and TM combinations.}
...
\begin{figure}[!h]
	...
	\caption{Bandwidth at $T_{amb}$. The label of the x axis are to be read as pump-signal-idler combinations. In order there are TE conbinations and TM combinations.}
...
This because we probably need to study further the geometry of the waveguide, 



As next step in enhancing the influence of temperature on effective index, different core geometries could be studied.
In order to enhance the effect of the overlap integrals between the optical mode and the thermal profile.
